...
#[command(
    long_about = "Execute curve fitting tests defined in JSON files. Each test specifies a sequence of operations (fit_curve, stroke, refit_stroke, register_skeleton, refit_stroke_with_skeleton) on a set of input points."
)]
struct Args {
